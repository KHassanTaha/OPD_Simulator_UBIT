...
Expected: `Passed! - Failed: 0`. As of 2026-09-16 **203 tests pass**:
...
- `OpdSimulator.App.Tests` (25, headless Avalonia, GUI rebuild Phase 1–3) — Avalonia.Headless
  ...
  navigation; shell screenshot render.
