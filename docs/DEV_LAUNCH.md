...
Expected: `Passed! - Failed: 0`. As of 2026-09-18 **332 tests pass**:
...
- `OpdSimulator.App.Tests` (154, headless Avalonia, GUI rebuild Phase 1–4, 4b, 4c, 5, 5c, 5c.4, 5d, 6c.1, 6c.2, 6c.3, 6c.4, 6c.5, 6c.6, 7A, 7B) — Avalonia.Headless
