...
Expected: `Passed! - Failed: 0`. As of 2026-09-16 **236 tests pass**:
...
- `OpdSimulator.App.Tests` (58, headless Avalonia, GUI rebuild Phase 1–4, 4b, 4c, 5, 5c) — Avalonia.Headless
